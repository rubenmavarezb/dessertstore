...
class Products{
    constructor(){
        ...
        *Params object dess - a specific object created in the data.json */
        this.buildIngredientsList = (dess) => {
            let html = ''
        ...
        */
        this.buildViewMoreCard = (divID, sourceData) => {
        ...
        *Params object sourceData - the data in data.json */
        this.buildList = (divID, sourceData) => {
            let container = sE(divID);
            container.innerHTML = '';
            let html = '';
